        ...
        <div class="p-2 bg-primary d-flex justify-content-between align-items-center rounded">
            ...
            <div class="dropdown">
                <button class="btn btn-light" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img
                        src="{{ isset(Auth::user()->photo) ? asset('storage/profile/'.\Illuminate\Support\Facades\Auth::user()->photo) : asset('dashboard/img/user-default-photo.png') }}"
                        class="user-img shadow-sm" alt=""
                    >
                    <span class="ml-0 ml-md-2 d-none d-md-inline-block">{{ \Illuminate\Support\Facades\Auth::user()->name }}</span>
                </button>
